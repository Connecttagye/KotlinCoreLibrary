...
object ComposeIconsList {
    val Add = Icons.Rounded.Add
    val Appearance = Icons.Rounded.Palette
    val ArrowBack = Icons.AutoMirrored.Rounded.ArrowBack
    val ArrowForward_Icon = Icons.AutoMirrored.Outlined.ArrowBackIos
    ...
    val Fast_Icon = Icons.Rounded.FastForward
    val FileOpen_Icon = Icons.Rounded.FileOpen
    val Folder_Icon = Icons.Rounded.Folder
    ...
    val Title_Icon = Icons.Rounded.Title
    val Update = Icons.Rounded.Update

    val Logout_Icon = Icons.AutoMirrored.Rounded.Logout
    val Profile_Icon = Icons.Rounded.PersonPinCircle
    val Notifications_Icon = Icons.Rounded.Notifications
    val Time_Icon = Icons.Rounded.AccessTime
}
